...
from sqlalchemy import Boolean, Column, String, Float, Integer, Text, Uuid
...
class OffreCredit(Base):
    ...
    nom_banque = Column(String(255), nullable=False)
    description = Column(Text, nullable=True)
    categorie_client = Column(String(50), nullable=False, default="particulier", server_default="particulier")
